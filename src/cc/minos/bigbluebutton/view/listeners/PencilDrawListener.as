package cc.minos.bigbluebutton.view.listeners
{
	...
	import cc.minos.bigbluebutton.view.shapes.*;
	...
	public class PencilDrawListener implements IDrawListener
	{
		...
		public function PencilDrawListener( wbCanvas:ISlidesView, sendShapeFrequency:int, shapeFactory:ShapeFactory )
		{
			_wbCanvas = wbCanvas;
...
//        LogUtil.debug("SEGMENT LENGTH = 0");
          ...
          //trace("END count = [" + objCount + "] id=[" + _curID + "]"); 
          objCount++;
