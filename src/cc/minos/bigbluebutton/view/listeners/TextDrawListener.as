...
package cc.minos.bigbluebutton.view.listeners {
    import cc.minos.bigbluebutton.view.ISlidesView;
    import cc.minos.bigbluebutton.view.models.WhiteboardTool;
    import cc.minos.bigbluebutton.view.shapes.ShapeFactory;
    import cc.minos.bigbluebutton.view.shapes.TextDrawAnnotation;
    ...
    public class TextDrawListener implements IDrawListener {
        private var _wbCanvas:ISlidesView
        ...
        public function TextDrawListener(wbCanvas:ISlidesView, sendShapeFrequency:int, shapeFactory:ShapeFactory)
        {
            _wbCanvas = wbCanvas;
        ...
        private function sendTextToServer(status:String, tobj:TextDrawAnnotation):void
        {
            ...
            _wbCanvas.sendGraphicToServer(tobj.createAnnotation());
        }
    }
}