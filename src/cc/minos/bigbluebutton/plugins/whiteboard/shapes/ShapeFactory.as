...
package cc.minos.bigbluebutton.plugins.whiteboard.shapes
{
	...
	public class ShapeFactory extends GraphicFactory
	{
		...
		{
			var tobj:TextDrawAnnotation = new TextDrawAnnotation( txt, txtColor, normalize( x, _parentWidth ), normalize( y, _parentHeight ), normalize( tbWidth, _parentWidth ), normalize( tbHeight, _parentHeight ), textSize, normalize( textSize, _parentHeight ) );
			return tobj;
		}
...
//            LogUtil.debug("***Making textObject [" + t.type + ", [" + t.annotation.x + "," + t.annotation.y + "]");
			var tobj:TextObject = new TextObject( t.annotation.text, t.annotation.fontColor, t.annotation.x, t.annotation.y, t.annotation.textBoxWidth, t.annotation.textBoxHeight, t.annotation.fontSize, t.annotation.calcedFontSize );
...
//            LogUtil.debug("***Redraw textObject [" + a.type + ", [" + a.annotation.x + "," + a.annotation.y + "]");
			var tobj:TextObject = new TextObject( a.annotation.text, a.annotation.fontColor, a.annotation.x, a.annotation.y, a.annotation.textBoxWidth, a.annotation.textBoxHeight, a.annotation.fontSize, a.annotation.calcedFontSize );
