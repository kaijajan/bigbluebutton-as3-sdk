package cc.minos.bigbluebutton.plugins.whiteboard.models
{
	...
	import cc.minos.bigbluebutton.plugins.whiteboard.events.GraphicObjectFocusEvent;
	import cc.minos.bigbluebutton.plugins.whiteboard.events.WhiteboardDrawEvent;
	import cc.minos.bigbluebutton.plugins.whiteboard.events.WhiteboardUpdate;
	...
	import cc.minos.bigbluebutton.plugins.whiteboard.shapes.GraphicFactory;
	import cc.minos.bigbluebutton.plugins.whiteboard.shapes.GraphicObject;
	...
	public class WhiteboardCanvasDisplayModel
	{
		...
		public var wbCanvas:IWhiteboard;
		...
		public function WhiteboardCanvasDisplayModel()
		{
		}
...
//              LogUtil.debug("Removing shape [" + gobj.id + "]");
						...
						{ // no DRAW_START event was thrown for o so place gobj back on the top
