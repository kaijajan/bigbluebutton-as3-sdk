...
package cc.minos.bigbluebutton.plugins.whiteboard.models
{
	...
	public class SlideViewModel
	{
		...
		private const MYSTERY_NUM:int = 1;
		
		public function SlideViewModel()
		{
		}
		...
		private function doWidthBoundsDetection():void
		{
			...
			//trace(  _calcPageW , _calcPageX * MYSTERY_NUM  , viewportW );
		...
		{
			//trace("Region [" + viewedRegionW + "," + viewedRegionH + "] [" + viewedRegionX + "," + viewedRegionY + "]");			
			//trace("Region [" + ((viewedRegionW / HUNDRED_PERCENT)*_calcPageW) + "," + ((viewedRegionH/HUNDRED_PERCENT)*_calcPageH) + 
		...
		{
			//trace("** disp viewer 1 [" + regionW + "," + regionH + "][" + x + "," + y + "]");
			...
			//trace("** disp viewer 2 [" + viewportW + "," + viewportH + "][" +_calcPageW + "," + _calcPageH + "][" + _calcPageX + "," + _calcPageY + "]");
		}
		...
		public function calculateViewportNeededForRegion( x:Number, y:Number, regionW:Number, regionH:Number ):void
		{
			...
			if ( parentW < parentH )
			{
				...
				if ( parentH < viewportH )
				{
					...
					trace( "calc viewport ***** resizing [" + viewportW + "," + viewportH + "] [" + parentW + "," + parentH + "," + fitToPage + "] [" + pageOrigW + "," + pageOrigH + "]" );
				}
			}
			else
			{
