...
package cc.minos.bigbluebutton.plugins.whiteboard.models
{
	...
	{
		private var _presentations:Array = [];
...
//            LogUtil.debug("*** Dispatched WhiteboardUpdate.BOARD_UPDATED Event ****");
		...
		public function addAnnotationFromHistory( presentationID:String, pageNumber:Number, annotation:Array ):void
		{
			...
			{
				//LogUtil.debug( "Wrong annotation history [curPresID=" + _currentPresentation.id + ",rxPresID=" + presentationID + "][curPage=" + _currentPresentation.getCurrentPageNumber() + ",rxPageNum=" + pageNumber + "]" );
				return;
			}
