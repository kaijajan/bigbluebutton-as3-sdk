 ...
 *
 */
package cc.minos.bbb.plugins.test
{
	...
	public class PortTest
	{
		 ...
		 */
		public function PortTest( protocol:String = "", hostname:String = "", port:String = "", application:String = "", testTimeout:Number = 10000 )
		{
		...
		protected function netStatus( event:NetStatusEvent ):void
		{
			...
			else if ( statusCode == "NetConnection.Connect.Rejected" || statusCode == "NetConnection.Connect.Failed" || statusCode == "NetConnection.Connect.Closed" )
			{
				status = "FAILED";
				_connectionListener( status, protocol, hostname, port, application );
			}
